...
-- index (IDX_MARKETSHARE_SEARCH_SUMMARY_STREAMS) is created idempotently in
-- ensure_marketshare_search_summary_columns() in sqlite_handler.py, which
-- runs immediately after this CREATE TABLE.
CREATE TABLE IF NOT EXISTS MARKETSHARE_SEARCH_SUMMARY (
